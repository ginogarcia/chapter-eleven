...
describe UsersController do
    ...
    describe "GET 'show'" do
        ...
        it "should show the user's micropost" do
            ...
            mp2 = Factory(:micropost, :user => @user, :content => "Bax Foo bar")
            get :show, :id => @user
        ...
        ###
        it "should have display the micropost count" do
    ...
    describe "authentication of edit/update actions" do
        ...
        describe "for signed-in users" do
            ...
            ###
            it "should require matchin users for 'edit'" do
                get :edit, :id => @user
                response.should redirect_to(root_path)
            end
            ###
             it "should require matchin users for 'update'" do
                put :update, :id => @user, :user => {}
                response.should redirect_to(root_path)
            end
        end
